...
describe('P2P Comprehensive End-to-End (n=3, t=2)', () => {
    ...
    it('Phase 1: Client triggers DKG broadcast on all nodes (P2P)', async () => {
        await Promise.all([
            axios.post(`${NODE_1_URL}/dkg/broadcast`),
            axios.post(`${NODE_2_URL}/dkg/broadcast`),
            axios.post(`${NODE_3_URL}/dkg/broadcast`),
        ])
    ...
    it('Phase 9: Node catch-up new state (P2P)', async () => {
