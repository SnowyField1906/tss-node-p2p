...
json_path = 'benchmark/e2e-report.json'
...
plt.tight_layout()
plt.savefig('benchmark/txs-plot.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('benchmark/dkg-plot.png', dpi=300, bbox_inches='tight')
